                    ...
                    if (abort) begin
                        ...
                        if (wb_ack_i) begin
                            ...
                            if ((xfer_count < 3 || (mode_2d && r_row_word_count == 16'd0)) && !wb_we_o) begin
                                ...
                                $fwrite(dma_ld_fh, "LD xfer=%0d addr=0x%08x data=0x%08x sram=%0d 2d=%0d rlen=%0d rcnt=%0d row=%0d/%0d\n",
                                        xfer_count, r_ext_addr, wb_dat_i, r_sram_addr, mode_2d, r_row_len, r_row_count,
