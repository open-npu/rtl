...
module npu_compute_tb #(
    ...
    wire [1:0]                          sa_cmd;
    wire                                sa_cmd_valid;
    wire signed [DATA_W-1:0]           sa_wgt_data  [0:ARRAY_SIZE-1];
    wire                                sa_wgt_valid;
    wire signed [DATA_W-1:0]           sa_act_data  [0:ARRAY_SIZE-1];
    wire                                sa_act_valid;
    ...
    npu_compute #(
        ...
        .sa_wgt_data(sa_wgt_data), .sa_wgt_valid(sa_wgt_valid),
        .sa_act_data(sa_act_data), .sa_act_valid(sa_act_valid),
        .sa_drain_col_sel(sa_drain_col_sel),
        .sa_acc_out(sa_acc_out), .sa_acc_out_valid(sa_acc_out_valid),
    ...
    npu_systolic #(
        ...
        .wgt_data(sa_wgt_data), .wgt_valid(sa_wgt_valid),
        .act_data(sa_act_data), .act_valid(sa_act_valid),
        .drain_col_sel(sa_drain_col_sel),
        .acc_out(sa_acc_out), .acc_out_valid(sa_acc_out_valid),
